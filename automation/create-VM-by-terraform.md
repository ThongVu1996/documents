...
- [3.Tiến hành lab](#3tiến-hành-lab)
  - [3.1 Tạo VM trên AWS EC2](#31-tạo-vm-trên-aws-ec2)
    - [3.1.1 Chuẩn bị hạ tầng](#311-chuẩn-bị-hạ-tầng)
    - [3.1.2 Tiến hành tạo VM](#312-tiến-hành-tạo-vm)
  - [3.2 Tạo VM trên Proxmox](#32-tạo-vm-trên-proxmox)
    - [3.2.1. Chuẩn bị](#321-chuẩn-bị)
...
- Cài đặt Terraform
 - Ở đây hướng dẫn cài đặt qua home-manager của nixdeamon
  - Vào trang web `https://search.nixos.org/packages` rồi search từ khóa `terrform` sẽ thấy kết qur như trong ảnh 
    ...
    ![terrform-in-nix-search](./terraform-in-nix.png)

  - Vào trong home.nix để thêm nó vào trong file như ảnh
        
    ![add-package-to-nix](./add-package-to-nix.png)

  - Build lại và kiểm tra bằng lệnh `terrform -v`
        
    ![check-version-terraform](./check-version-terraform.png)
...
- Cài đặt Vscode
    ...
    ![hashicorp-terraform-ext](./hashicorp-terraform-ext.png)
    
    ![hashiCorp-HCL-ext](./hashiCorp-HCL-ext.png)
...
[tại đây](https://github.com/ThongVu1996/cd-ci-lab/blob/master/aws/install.md)).
   ...
   đã khai báo trong file `.tf`. Bạn vào mục search gõ `AMI Catalog` rồi lựa chọn `AMI ID` như ảnh.
      ...
      ![search-ami-catalog](./search-ami-catalog.png)
   ...
   - Tạo VPC và tạo Subnet để có thể tạo máy ảo trên đó. 
      ...
      ![create-subnet-in-vpc](./create-subnet-in-vpc.png)

      ![subnet-id](./subnet-id.png)
  ...
  #### 3.1.2 Tiến hành tạo VM
   ...
   - Chạy lệnh sau ở thử mục chứa file `main.tf`:
     ...
     ```
        ...
        ![terrform-apply-1](./terrform-apply-1.png)
        
        ![terraform-apply-2](./terraform-apply-2.png)

   - Kết tạo ra 1 instance trong EC2:

      ![result-terraform](./result-terraform.png)
...
- Ta thấy tự động tạo VPC, Subnet, rồi tiếp tục tạo instance. Lên AWS console để kiểm chứng
  ...
  ![terrform-auto-apply](./terrform-auto-apply.png)

  ![terrform-create-vpc](./terrform-create-vpc.png)


  ![terraform-creat-subnet](./terraform-creat-subnet.png)
...
- Tương tự để hủy thì sẽ chạy lệnh
   ...
   ![terraform-auto-destroy](./terraform-auto-destroy.png)
...
#### 3.2.4 Kết quả
   - Kiểm tra trên promox 
     ...
     ![create-vm-promox](./create-vm-promox.png)
